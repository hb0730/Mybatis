package org.mybatis.spring.day02.common;
...
public class Logs {
     ...
     * @param joinPoint
     */
    @Before("execution(* org.mybatis.spring.day02.service.inter.*.*(..))")
     ...
     * @param joinPoint
     */
    @After("execution(* org.mybatis.spring.day02.service.inter.*.*(..))")
     ...
     * @return
     */
    @Around("execution(* org.mybatis.spring.day02.service.inter.*.*(..))")
     ...
     * @param e
     */
    @AfterThrowing(value = "execution(*org.mybatis.spring.day02.service.inter.*.*(..))",throwing = "e")
    ...
    //在方法正常结束后要执行的代码
    //返回通知是可以访问到方法的返回值的
    @AfterReturning(value = "execution(*org.mybatis.spring.day02.service.inter.*.*(..))",returning = "result")
